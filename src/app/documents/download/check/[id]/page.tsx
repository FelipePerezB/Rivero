...
import Document from "src/app/documents/components/elements/files/document";
import generateRandomId from "src/utils/generateRandomId";
import { IdLenght } from "src/models/document.model";
import FileContainer from "src/app/documents/components/layout/file-container/file-container";
import Section from "src/app/documents/components/elements/files/section";
import Title from "src/app/documents/components/elements/files/title";
export default async function DownloadFilePage({
  ...
  return (
    <>
      <FileContainer>
        <Section>
          <Title options={{ size: "h1", text: "Respuestas " + data.title }} />
